...
```text
Use $skill-installer to install this skill from https://github.com/lisijia666-sketch/codex-computer-use-fix/tree/main/skills/codex-computer-use-fix
```

或者使用本地 helper 脚本：

```powershell
python "$env:USERPROFILE\.codex\skills\.system\skill-installer\scripts\install-skill-from-github.py" --repo lisijia666-sketch/codex-computer-use-fix --ref main --path skills/codex-computer-use-fix
```
...
本仓库只是本地诊断和修复流程，不是 OpenAI 官方支持渠道。如果修复后仍不可用，请更新 Codex、重启电脑，并联系 OpenAI 支持或检查你的账号、地区或组织策略。
